...
import kotlinx.android.synthetic.main.activtiy_test_update_viewpager.*

class TestUpdateViewPagerActivity : Activity(), OnClickListener {

    companion object {
        const val TAG = "TestUpdateViewPagerActivity"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_insert.setOnClickListener(this@TestUpdateViewPagerActivity)
